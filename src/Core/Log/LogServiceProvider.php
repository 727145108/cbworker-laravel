...
class LogServiceProvider extends ServiceProvider
{
    ...
    {
        $log->useFiles(
            $this->app->runtimePath().'/logs/cbworker.log',
            $this->logLevel()
        );
    }
    ...
    {
        $log->useDailyFiles(
            $this->app->runtimePath().'/logs/cbworker.log', $this->maxFiles(),
            $this->logLevel()
        );
    }
    ...
    {
        $log->useSyslog('cbworker', $this->logLevel());
    }
